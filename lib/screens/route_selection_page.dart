...
final List<LocationItem> _allHouses = [
  LocationItem(name: "Green Garden House", coordinates: const LatLng(11.0168, 76.9558), address: "Gandhipuram", type: 'house'),
  LocationItem(name: "Laxmi Nagar Villa", coordinates: const LatLng(11.0012, 76.9621), address: "Peelamedu", type: 'house'),
  LocationItem(name: "Skyview Apartments", coordinates: const LatLng(10.9985, 76.9920), address: "Avinashi Road", type: 'house'),
  LocationItem(name: "Royal Enclave", coordinates: const LatLng(11.0234, 76.9421), address: "RS Puram", type: 'house'),
  LocationItem(name: "Sunny Side Home", coordinates: const LatLng(11.0450, 76.9320), address: "Saibaba Colony", type: 'house'),
  LocationItem(name: "The White House", coordinates: const LatLng(10.9821, 76.9210), address: "Kuniamuthur", type: 'house'),
  LocationItem(name: "Serene Villa", coordinates: const LatLng(11.0820, 76.9810), address: "Saravanampatti", type: 'house'),
  LocationItem(name: "City Center Flat", coordinates: const LatLng(11.0120, 76.9820), address: "Pappanaickenpalayam", type: 'house'),
  LocationItem(name: "Blue Hill Residence", coordinates: const LatLng(11.0310, 76.9120), address: "Vadavalli", type: 'house'),
  LocationItem(name: "Metro Home", coordinates: const LatLng(11.0020, 76.9720), address: "Race Course", type: 'house'),
];

// --- DATA SOURCE 2: Compiled_Colleges_in_near_Coimbatore.csv ---
final List<LocationItem> _allColleges = [
  LocationItem(name: "PSG College of Technology", coordinates: const LatLng(11.0247, 77.0028), address: "Peelamedu", type: 'college'),
  LocationItem(name: "Coimbatore Institute of Technology", coordinates: const LatLng(11.0285, 77.0224), address: "Avinashi Road", type: 'college'),
  LocationItem(name: "Kumaraguru College of Technology", coordinates: const LatLng(11.0772, 76.9882), address: "Saravanampatti", type: 'college'),
  LocationItem(name: "Sri Krishna College of Eng. & Tech", coordinates: const LatLng(10.9385, 76.9545), address: "Kuniamuthur", type: 'college'),
  LocationItem(name: "Amrita Vishwa Vidyapeetham", coordinates: const LatLng(10.9027, 76.9006), address: "Ettimadai", type: 'college'),
  LocationItem(name: "Hindusthan College", coordinates: const LatLng(11.0020, 77.0250), address: "Nava India", type: 'college'),
  LocationItem(name: "Karpagam College", coordinates: const LatLng(10.8800, 77.0200), address: "Othakkalmandapam", type: 'college'),
  LocationItem(name: "Dr. N.G.P. Institute", coordinates: const LatLng(11.0550, 77.0450), address: "Kalapatti", type: 'college'),
  LocationItem(name: "SNS College of Technology", coordinates: const LatLng(11.0950, 77.0150), address: "Saravanampatti", type: 'college'),
  LocationItem(name: "Sri Ramakrishna Eng. College", coordinates: const LatLng(11.1050, 76.9450), address: "Vattamalaipalayam", type: 'college'),
  LocationItem(name: "Government College of Technology", coordinates: const LatLng(11.0180, 76.9380), address: "Thadagam Road", type: 'college'),
  LocationItem(name: "KG College of Arts and Science", coordinates: const LatLng(11.0850, 76.9950), address: "Saravanampatti", type: 'college'),
];
