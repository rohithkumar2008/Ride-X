...
import 'bonafide_page.dart'; // 👉 Imports the next page
                ...
                Center(
                  child: GestureDetector(
                    ...
                    child: AnimatedContainer(
                      ...
                      height: 220, // Wide landscape for ID cards
                ...
                Center(
                  child: Column(
                    children: [
                      Text(
                        _hasFile 
                            ? (_isSizeTooLarge ? "File too large: $_fileSizeKB KB" : "Size OK: $_fileSizeKB KB")
                            : "Standard Format: Image / Scan",
                        style: TextStyle(
                          fontFamily: 'SF Pro Display',
                          fontSize: 13,
                          fontWeight: FontWeight.w600,
                          color: (_hasFile && _isSizeTooLarge) ? appleRed : greyText,
                        ),
                      ),
                  ...
                  children: [
                    _buildAppleButton(
                      ...
                      onTap: (_isUploading || (_hasFile && _isSizeTooLarge)) 
                          ? null 
                          : (_hasFile 
                              // 👉 FIXED: NOW POINTS TO BonafideUploadPage
                              ? () => Navigator.push(context, MaterialPageRoute(builder: (context) => const BonafideUploadPage())) 
  ...
  Widget _buildPreviewContent() {
        ...
        children: [
          ...
          Center(
            child: _isSizeTooLarge 
                ? const Icon(Icons.warning_amber_rounded, size: 60, color: appleRed)
                : null, 
          ),
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 12),
        const Text("Choose ID Photo", style: TextStyle(fontFamily: 'SF Pro Display', color: appleBlue, fontWeight: FontWeight.w600, fontSize: 18)),
      ],
    );
  }
